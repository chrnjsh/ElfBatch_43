...
public class TologinaToTrelloAndclickOnBoards {
	public static void main(String[] args) {
		...
		WebElement addText = driver.findElement(By.xpath("//span[text()='manual testing']"));
		Actions actions = new Actions(driver);
		actions.contextClick(addText).perform();
		List<WebElement> contextmenu = driver.findElements(By.xpath("//div[@class=\"quick-card-editor-buttons fade-in\"]"));
